...
function rebrand(text: string): string {
    return text
        ...
        .replace(/chef's/g, "buddy's")
        .replace(/Chef(?![a-z])/g, "Buddy") // Chef not followed by lowercase (to avoid "Chefland" double replace)
...
1100`,
        ...
        testCases: [
            ...
            { input: "2\n24 50 500\n6 200 1200", output: "1000\n1200", isSample: false },
            { input: "2\n1 100 1200\n13 100 1000", output: "100\n1100", isSample: false },
        ],
    },
